...
# Hyperparameters
LR = 0.001
MEMORY_SIZE = 10000 # Pujar per mirar si puc posar mes prtides i experiencia perq aixo son unes dues partides.
MAX_EPISODES = 2 #5000
MAX_TIMESTEPS = 10
EPSILON = 0.99
...
class DQNAgent:
    ...
    def train(self, gamma=0.99, max_episodes=50000, batch_size=32, dnn_update_frequency=4, dnn_sync_frequency=2000, max_timesteps=1000):
        ...
        while training:
            ...
            while (not gamedone) and (frames < max_timesteps):
                ...
                if gamedone:
                    ...
                    torch.save(self.dnnetwork.state_dict(), "model_DQN_last.pth")

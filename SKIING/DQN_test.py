...
#test:
# 1. Load the model saved as "model_DQN_last_manual.pth"
...
# Save also the gifs from the rendered frames in a folder called "gifs_test_DQN"
...
for i in range(n_episodes):
    ...
    os.makedirs("gifs_test_DQN", exist_ok=True)
    frames[0].save(f"gifs_test_DQN/episode_{i + 1}.gif", save_all=True, append_images=frames[1:], duration=100, loop=0)
...
plt.savefig("gifs_test_DQN/rewards_plot.png")
plt.close()
